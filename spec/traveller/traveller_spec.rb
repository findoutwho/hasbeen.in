...
describe "A traveller" do
  ...
  let(:traveller) { traveller = Traveller.find("Bascht", "spec/files/") }
  ...
  it "should initialize with a name and some Properties" do
    ...
    traveller.profile.should == { "web" => "http://bascht.com", "twitter" => "bascht" }
  end

  it "should have been to some location" do
    traveller.locations.count.should == 5
    traveller.locations.should == [ "Leipzig", "Hamburg", "Oelsnitz", "Bangkok", "Shanghai" ]
  end
